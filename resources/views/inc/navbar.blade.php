        ...
        <ul class="navbar-item flex-row ml-md-auto">
            <div class="page-header" style="margin-top: 7px;">
                <div class="toggle-switch">
                    <label class="switch s-icons s-outline  s-outline-secondary">
                        <input type="checkbox" @if(Cookie::get('dark_mode') == '0' ) checked="checked" @elseif(Cookie::get('dark_mode') == '1' ) @endif class="theme-shifter" id="theme-shifter" @if(Cookie::get('dark_mode') ==1 ) value="0" @else value=1 @endif  name="checkbox">
            ...
            <li class="nav-item dropdown user-profile-dropdown">
                ...
                <div class="dropdown-menu position-absolute" aria-labelledby="userProfileDropdown">
                    <div class="">
                        <div class="dropdown-item">
                            <a class="" href="{{ route('user-profile') }}"><svg xmlns="http://www.w3.org/2000/svg"
            ...
            <li>
                <div class="page-header">
                    ...
                    <nav class="breadcrumb-one" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0);">@yield('category')</a></li>
